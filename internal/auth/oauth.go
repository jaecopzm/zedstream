...
// HandleDevLogin creates or retrieves a test user and issues tokens.
func (s *OAuthService) HandleDevLogin(ctx context.Context) (*TokenPair, error) {
	return s.upsertUserAndIssueTokens(ctx, &OAuthUser{
		ProviderID: "dev_test_123",
		Email: "test@zedbeatz.com",
		Name:       "Developer Demo",
		Provider:   "dev",
	})
}

// upsertUserAndIssueTokens inserts or updates the user and returns tokens.
